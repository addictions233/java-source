...
public abstract class TransactionSynchronizationManager {
	...
	// Map中的key为DataSource对象，value为ConnectionHolder对象
	...
	private static Object doGetResource(Object actualKey) {
		...
		// 可以通过resources.get()方法判断当前线程是否持有datasource所创建的数据库连接connection
		Map<Object, Object> map = resources.get();
		if (map == null) {
			return null;
		}
	...
	public static void bindResource(Object key, Object value) throws IllegalStateException {
		...
		// resources是一个ThreadLocal对象, 用来缓存当前线程中由某个DataSource所创建的数据库连接connection
		// 获取的map中的key为DataSource对象，value为ConnectionHolder对象
		Map<Object, Object> map = resources.get();
