...
abstract class ConfigurationClassUtils {
	...
	public static boolean checkConfigurationClassCandidate(
		...
		// @Bean定义的配置类Bean是不起作用的, @Bean定义的bean这里获取beanClassName属性为空的
		// 所以要注意这个方法的调用入口
		...
		// proxyBeanMethod属性默认true, 所以默认是Full配置类
		...
		// 或者不存在@Configuration，只要存在@Bean注解了的方法，就是lite配置类, 例如在启动类AppConfig.class中定义@Bean修饰的方法
