                ...
                try {
                    ...
                    for (Map.Entry<String, Connection> entry : entries) {
                        ...
                        if (integer != null && integer.intValue() > 0) {
                            ...
                            // 当前时间减去客户端的上次心跳时间 >= 存活时间20s, 将连接id加入到过期连接中
                    ...
                    //4.client active detection.  客户端健康检测
                        ...
                        for (String outDateConnectionId : outDatedConnections) {
                            try {
                                ...
                                if (connection != null) {
                                    ...
                                    // 服务端向客户端发送检测请求: 探活, 检测客户端是否真的挂了
                                    // grpc是长连接, 适合做探活, 而1.4.x版本是http连接, 不适合做探活
