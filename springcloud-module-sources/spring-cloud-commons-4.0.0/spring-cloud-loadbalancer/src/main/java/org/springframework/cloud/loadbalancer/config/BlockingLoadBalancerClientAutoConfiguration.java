...
@LoadBalancerClients
@AutoConfigureAfter(LoadBalancerAutoConfiguration.class)  // 在LoadBalancerAutoConfiguration.class之后自动装配
@AutoConfigureBefore({ org.springframework.cloud.client.loadbalancer.LoadBalancerAutoConfiguration.class })
@ConditionalOnClass(RestTemplate.class)
public class BlockingLoadBalancerClientAutoConfiguration {

	/**
	 * 创建LoadBalancerClient负载均衡客户端, 类型是BlockingLoadBalancerClient
	 * @param loadBalancerClientFactory 负载均衡器工厂, 用与创建负载均衡客户端
	 * @return
	 */
	@Bean
