...
/**
 * k1 dubbo中对于@Service注解修饰的Bean对象, 都会创建一个ServiceBean类型的Bean对象
 * ServiceFactoryBean
 *
 * @export
 */
public class ServiceBean<T> extends ServiceConfig<T> implements InitializingBean, DisposableBean,
    ...
    /**
     * k2 ServiceBean服务导出的方法入口, 当spring容器启动完成之后会发布事件, 然后dubbo监听到事件后导出服务
    ...
    /**
     * k1 服务注册的方法入口: 将服务信息注册到注册中心, 启动tomcat或者netty支持远程调用
     * @since 2.6.5
     */
    @Override
    public void export() {
